...
// 插件市场相关状态
const pluginMarketplace = reactive({
...
const filteredPlugins = computed(() => {
  if (!pluginMarketplace.searchQuery) {
    return pluginMarketplace.availablePlugins
  }
  const query = pluginMarketplace.searchQuery.toLowerCase()
  return pluginMarketplace.availablePlugins.filter((plugin) => {
...
const loadAvailablePlugins = async () => {
  pluginMarketplace.loading.available = true
  try {
    const result = await window.FBW.getAvailablePlugins()
    if (result.success) {
      pluginMarketplace.availablePlugins = result.data || []
    } else {
    ...
    pluginMarketplace.loading.available = false
  }
}

const loadInstalledPlugins = async () => {
  pluginMarketplace.loading.installed = true
  try {
    const result = await window.FBW.getInstalledPlugins()
    if (result.success) {
      pluginMarketplace.installedPlugins = result.data || []
    } else {
    ...
    pluginMarketplace.loading.installed = false
  }
}

const installPlugin = async (pluginName) => {
  pluginMarketplace.loading.installing = true
  try {
    ...
    pluginMarketplace.loading.installing = false
  }
}

const uninstallPlugin = async (pluginName) => {
  pluginMarketplace.loading.uninstalling = true
  try {
    ...
    pluginMarketplace.loading.uninstalling = false
  }
}

const updatePlugin = async (pluginName) => {
  pluginMarketplace.loading.updating = true
  try {
    ...
    pluginMarketplace.loading.updating = false
  }
}

const showPluginDetailDialog = (plugin) => {
  pluginMarketplace.currentPlugin = plugin
  pluginMarketplace.showPluginDetail = true
}

const isPluginInstalled = (pluginName) => {
  return pluginMarketplace.installedPlugins.some((plugin) => plugin.name === pluginName)
}

const getInstalledPluginVersion = (pluginName) => {
  const plugin = pluginMarketplace.installedPlugins.find((p) => p.name === pluginName)
...
onMounted(async () => {
  ...
  // 加载插件数据
  if (activeTab.value === 'pluginMarketplace') {
    await loadAvailablePlugins()
    await loadInstalledPlugins()
  }
})
...
<template>
  <el-main class="page-setting">
    ...
    <div v-show="activeTab === 'pluginMarketplace'" class="plugin-marketplace-wrapper">
      <el-scrollbar style="height: 100%">
        <div class="plugin-marketplace">
          <el-tabs v-model="pluginMarketplace.activeTab">
            <el-tab-pane :label="t('pages.Setting.pluginMarketplace.tabs.marketplace')" name="marketplace">
              <div class="marketplace-content">
                <div class="search-box">
                  <el-input
                    v-model="pluginMarketplace.searchQuery"
                  ...
                  <el-button
                    type="primary"
                    :loading="pluginMarketplace.loading.available"
                ...
                <el-empty v-if="!pluginMarketplace.loading.available && filteredPlugins.length === 0" />

                <div v-loading="pluginMarketplace.loading.available" class="plugin-grid">
                  <div
                  ...
                  >
                    ...
                    <div class="plugin-footer">
                      ...
                      <el-button
                        ...
                        :loading="pluginMarketplace.loading.installing"
            ...
            <el-tab-pane :label="t('pages.Setting.pluginMarketplace.tabs.installed')" name="installed">
              <div class="installed-content">
                <el-button
                  type="primary"
                  :loading="pluginMarketplace.loading.installed"
                ...
                <el-empty v-if="!pluginMarketplace.loading.installed && pluginMarketplace.installedPlugins.length === 0" />

                <div v-loading="pluginMarketplace.loading.installed" class="plugin-list">
                  <div
                    v-for="plugin in pluginMarketplace.installedPlugins"
                    :key="plugin.name"
                  ...
                  >
                    ...
                    <div class="plugin-actions">
                      ...
                      <el-button
                        type="primary"
                        :loading="pluginMarketplace.loading.updating"
                      ...
                      <el-button
                        type="danger"
                        :loading="pluginMarketplace.loading.uninstalling"
    ...
    <el-dialog
      v-model="pluginMarketplace.showPluginDetail"
      :title="pluginMarketplace.currentPlugin?.displayName || pluginMarketplace.currentPlugin?.name"
      width="600px"
    >
      <div v-if="pluginMarketplace.currentPlugin" class="plugin-detail">
        <div class="detail-row">
          <span class="detail-label">{{ t('pages.Setting.pluginMarketplace.name') }}:</span>
          <span class="detail-value">{{ pluginMarketplace.currentPlugin.displayName || pluginMarketplace.currentPlugin.name }}</span>
        </div>
        <div class="detail-row">
          <span class="detail-label">{{ t('pages.Setting.pluginMarketplace.version') }}:</span>
          <span class="detail-value">v{{ pluginMarketplace.currentPlugin.version }}</span>
        </div>
        <div class="detail-row">
          <span class="detail-label">{{ t('pages.Setting.pluginMarketplace.author') }}:</span>
          <span class="detail-value">{{ pluginMarketplace.currentPlugin.author }}</span>
        </div>
        <div class="detail-row">
          <span class="detail-label">{{ t('pages.Setting.pluginMarketplace.description') }}:</span>
          <span class="detail-value">{{ pluginMarketplace.currentPlugin.description }}</span>
        </div>
        <div v-if="pluginMarketplace.currentPlugin.site" class="detail-row">
          <span class="detail-label">{{ t('pages.Setting.pluginMarketplace.website') }}:</span>
          <el-link :href="pluginMarketplace.currentPlugin.site" target="_blank">
            {{ pluginMarketplace.currentPlugin.site }}
          </el-link>
        </div>
        <div v-if="pluginMarketplace.currentPlugin.appVersion" class="detail-row">
          <span class="detail-label">{{ t('pages.Setting.pluginMarketplace.appVersion') }}:</span>
          <span class="detail-value">
            {{ pluginMarketplace.currentPlugin.appVersion.min }} - {{ pluginMarketplace.currentPlugin.appVersion.max }}
          </span>
        </div>
      </div>
      <template #footer>
        <el-button @click="pluginMarketplace.showPluginDetail = false">
