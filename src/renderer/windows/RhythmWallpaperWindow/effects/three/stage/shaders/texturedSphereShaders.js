...
/**
 * 纹理球 Shader：顶点 Perlin + 纬向正弦波 + audioData[128] 位移；
 * 片元按位移/音频强度走 rhythmPalette。球心缩放由 sphereSize 控制。
 */
export const TEXTURED_SPHERE_VERT = `uniform float time;
...
export const TEXTURED_SPHERE_FRAG = `${RHYTHM_PALETTE_GLSL}
...
void main() {
  ...
  // 纬向热力：绕 Y 轴径向，赤道 dist=0，两极 dist=1
