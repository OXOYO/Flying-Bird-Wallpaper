...
Flying Bird Wallpaper is a feature-rich desktop wallpaper software that supports various wallpaper types including images, videos, rhythm, and solid colors, making your desktop uniquely charming.

- [Quick Start](./docs/start.md)
- [Function Modules](./docs/module.md)
- [Main Process](./docs/main_process.md)
- [Child Process](./docs/child_process.md)
- [Process Communication](./docs/process_communication.md)
- [Renderer Process](./docs/renderer_process.md)
- [Image Wallpaper](./docs/image_wallpaper.md)
